...
#define	_CAT(X,...)	X ## __VA_ARGS__
#define	CAT(X,...)	_CAT(X,__VA_ARGS__)
#define	IFF(COND)	_CAT(IFF_,COND)
#define	IFF_0(TRUE,...)	__VA_ARGS__
#define	IFF_1(TRUE,...)	TRUE
#define	COMPL(X)	_CAT(COMPL_,X)
#define	COMPL_0		1
#define	COMPL_1		0
#define	BITAND(X)	_CAT(BITAND_,X)
#define	BITAND_0(X)	0
#define	BITAND_1(X)	X
#define	BITOR(X)	_CAT(BITAND_,X)
#define	BITOR_0(X)	X
#define	BITOR_1(X)	1
...
#define	PROBE(x)	x, 1,
#define	IS_PAREN(x)	CHECK(IS_PAREN_ x)
#define	IS_PAREN_(...)	PROBE(~)
...
#define	EVAL9(...)	EVALa(EVALa(EVALa(__VA_ARGS__)))
#define	EVALa(...)	__VA_ARGS__
